...
CREATE TABLE `projektai` (
  ...
  `projektas` varchar(255) COLLATE utf8mb4_lithuanian_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=231 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_lithuanian_ci;
...
INSERT INTO `projektai` VALUES (1,'PHP'),(2,'Java'),(3,'JS React'),(4,'HTML'),(5,'CSS');
